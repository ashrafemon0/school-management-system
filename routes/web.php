...
Route::prefix('student')->group(function (){
    ...
    Route::post('/reg/update/{student_id}',[StudentRegController::class,'StudentRegUpdate'])->name('store.student.reg');
    Route::post('/student/class/delete/{id}',[StudentRegController::class,'ClassDelete'])->name('class.delete');
