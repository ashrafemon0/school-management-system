        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if(Auth::user()->role == 'admin')
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('account.student.fee.view')}}"><i class="ti-more"></i>Monthly and Early Report</a></li>
                        <li><a href="{{route('account.teacher.fee.view')}}"><i class="ti-more"></i>Attendance Report</a></li>
                        <li><a href="{{route('other.cost.view')}}"><i class="ti-more"></i>MarkShit Generate</a></li>
                    </ul>
                </li>
            @endif
